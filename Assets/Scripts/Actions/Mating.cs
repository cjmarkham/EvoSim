...
public class Mating : Action {
    ...
    private ParticleSystem sheepParticles;
    private ParticleSystem mateParticles;
    ...
    public override void OnStart(Sheep sheep) {
        ...
        sheepParticles = Sheep.GetComponent<ParticleSystem>();
        mateParticles = ClosestMate.GetComponent<ParticleSystem>();
        sheepParticles.Play();
        mateParticles.Play();
    }
